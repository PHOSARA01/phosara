...
| 高 | `company/04_sales/` | 営業標準書 — `SALES_PLAYBOOK_v2.md` / 営業現場ガイド — `SALES_FIELD_GUIDE.md` / 営業ログ規程 — `SALES_LOG_STANDARD.md` / 営業対象選定基準 — `SALES_TARGET_CRITERIA.md` / 栃木県営業対象リスト — `SALES_TARGET_LIST_TOCHIGI_v1.md` / 営業実行ツールキット — `SALES_EXECUTION_TOOLKIT.md` |
