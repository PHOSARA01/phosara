...
| 高 | `company/04_sales/` | 営業標準書 — `SALES_PLAYBOOK_v2.md` / 営業現場ガイド — `SALES_FIELD_GUIDE.md` / 営業ログ規程 — `SALES_LOG_STANDARD.md` / 営業対象選定基準 — `SALES_TARGET_CRITERIA.md` / 栃木県営業対象リスト — `SALES_TARGET_LIST_TOCHIGI_v1.md` / 営業実行ツールキット — `SALES_EXECUTION_TOOLKIT.md` / 初回営業先決定 — `FIRST_SALES_TARGET_DECISION.md` |
...
| 高 | `company/13_ai-company/` | AI Company設計資産 — AI企業OS — `PHOSARA_AI_COMPANY_OS_v1.md` / 実装ロードマップ — `PHOSARA_AI_IMPLEMENTATION_ROADMAP.md` / AI従業員定義 — `agents/`（CEO・Sales・CS・Knowledge・PBOS） / 実装基盤（Phase 0）— `implementation/`（STATE・WORKFLOW・AGENTS・HUMAN_APPROVAL・VERIFICATION・IMPLEMENTATION_LOG・DIRECTORY_STRUCTURE・.env.example・logs/） / Runtime仕様 — `runtime/`（CEO・Sales・CS・Knowledge・PBOS 各 Runtime） / Sales AI MVP（Phase 1）— `implementation/phase1-sales-mvp/`（WORKFLOW・STATE・INPUT・OUTPUT・OWNER_APPROVAL_QUEUE・LOG・DAILY_REPORT・CONFLICT_LOG） / Client Success AI MVP（Phase 1）— `implementation/phase1-client-success-mvp/`（WORKFLOW・STATE・INPUT・OUTPUT・OWNER_APPROVAL_QUEUE・LOG・DAILY_REPORT・CONFLICT_LOG） / Knowledge AI MVP（Phase 1）— `implementation/phase1-knowledge-mvp/`（WORKFLOW・STATE・INPUT・OUTPUT・KNOWLEDGE_APPROVAL_QUEUE・LOG・DAILY_REPORT・CONFLICT_LOG） / PBOS AI MVP（Phase 1）— `implementation/phase1-pbos-mvp/`（WORKFLOW・STATE・INPUT・OUTPUT・PBOS_APPROVAL_QUEUE・LOG・DAILY_REPORT・CONFLICT_LOG） / CEO AI MVP（Phase 1）— `implementation/phase1-ceo-mvp/`（WORKFLOW・STATE・INPUT・OUTPUT・CEO_APPROVAL_QUEUE・LOG・DAILY_CEO_BRIEF・CONFLICT_LOG） |
...
完了済み:
  ...
  ✓ AI Company Runtime 整備 — Runtime仕様5本の正式登録（company/13_ai-company/runtime/）
  ✓ AI Company Implementation Phase 1 — Sales AI MVP 実装基盤（company/13_ai-company/implementation/phase1-sales-mvp/）
  ✓ AI Company Implementation Phase 1 — Client Success AI MVP 実装基盤（company/13_ai-company/implementation/phase1-client-success-mvp/）
  ✓ AI Company Implementation Phase 1 — Knowledge AI MVP 実装基盤（company/13_ai-company/implementation/phase1-knowledge-mvp/）
  ✓ AI Company Implementation Phase 1 — PBOS AI MVP 実装基盤（company/13_ai-company/implementation/phase1-pbos-mvp/）
  ✓ AI Company Implementation Phase 1 — CEO AI MVP 実装基盤（company/13_ai-company/implementation/phase1-ceo-mvp/）
