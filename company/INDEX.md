...
| 高 | `04_sales/` | 営業標準書・現場ガイド・ログ規程・対象選定基準・営業対象リスト | `SALES_PLAYBOOK_v2.md`, `SALES_FIELD_GUIDE.md`, `SALES_LOG_STANDARD.md`, `SALES_TARGET_CRITERIA.md`, `SALES_TARGET_LIST_TOCHIGI_v1.md` |
